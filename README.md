...
You can use the tss command line tool (check installation method on the tss page) you can set local_tss to false, but with so the plugin will be perhaps behind TSS in terms of update and it could make the plugin not working is there's some api change.
